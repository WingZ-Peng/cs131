...
let my_subset_test_1 = subset [3;3] [3]
...
let my_set_union_test1 = equal_sets (set_union [1;1] [1;1]) [1]
...
let my_set_intersection_test0 =
  equal_sets (set_intersection [1] [1]) [1]
let my_set_intersection_test1 =
  equal_sets (set_intersection [5] [5;5;5]) [5]
...
let my_set_diff_test0 = equal_sets (set_diff [4] [4]) []
let my_set_diff_test1 = equal_sets (set_diff [4;4] [4]) []
...
let my_computed_fixed_point_test0 =
  computed_fixed_point (=) (fun x -> x / 128) 256 = 0
...
let my_rle_decode_test0 = 
  rle_decode [1,"h"; 1,"e"; 2,"l"; 1,"o"; 0,"x"] = ["h"; "e"; "l"; "l"; "o"]
...
let archer_test0 = filter_blind_alleys archer_grammar = 
  (Utterance,
    [Complaint, [T"Get it together, "; N Person];
    Complaint, [T"I'm kind of in the middle of something, "; N Person];
    Quip, [T"You're entering the Danger Zone!"];
